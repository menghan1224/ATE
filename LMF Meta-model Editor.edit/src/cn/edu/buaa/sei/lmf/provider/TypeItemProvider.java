...
/**
 * This is the item provider adapter for a {@link cn.edu.buaa.sei.lmf.Type} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LMFPackage.Literals.TYPE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LMFPackage.Literals.TYPE__SUPER_TYPES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LMFPackage.Literals.TYPE__ABSTRACT,
				 true,
				 false,
				 false,
	...
	protected void addFinalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Type_final_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Type_final_feature", "_UI_Type_type"),
				 LMFPackage.Literals.TYPE__FINAL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LMFPackage.Literals.TYPE__CATEGORIES);
		}
	...
	public String getText(Object object) {
		...
		if (label == null || label.length() == 0) {
			...
			EList<Type> superTypes = ((Type)object).getSuperTypes();
			if (superTypes.size() == 0) {
				...
				sb.append(label);
				sb.append(" -> ");
				sb.append(getNameForType(superTypes.get(0)));
				for (int i = 1; i < superTypes.size(); i++) {
					sb.append(", ");
					sb.append(getNameForType(superTypes.get(i)));
				}
				return sb.toString();
			}
		}
	...
	private String getNameForType(Type type) {
		if (type.getName() == null || type.getName().length() == 0) return "<Type>";
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LMFPackage.Literals.TYPE__CATEGORIES,
				 LMFFactory.eINSTANCE.createCategory()));
	}
