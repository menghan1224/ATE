...
public class MultiRefAttributeDescriptor implements IAttributeDescriptor {
	...
	private class Cell extends DialogCellEditor {
		...
		protected Object openDialogBox(Control cellEditorWindow) {
			MultiRefDialog dialog = new MultiRefDialog(cellEditorWindow.getShell());
			dialog.init(type, (Object[]) getValue(), resource.getRootObject());
	...
	public MultiRefAttributeDescriptor(Type type, String key, FileResource resource) {
		this.key = key;
		this.type = type;
