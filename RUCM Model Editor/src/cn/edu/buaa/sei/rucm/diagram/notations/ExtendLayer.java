...
public class ExtendLayer extends AbstractLineLayer<UCDExtendLink> {

	private TextLayout textLayout;
	
	public ExtendLayer(ManagedObject model) {
		super(model);
		textLayout = null;
	}
	...
	public void addElementToContainer(ContainerView<?> container, UCDNode node1, UCDNode node2, ManagedObject element) {
		...
		if (value1 instanceof UseCase) {
			((UseCase) value1).getExtend().add(extend);
		}
	}
