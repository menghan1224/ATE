...
public class SpecificRFSRow extends EmbeddedRow {
	
	public SpecificRFSRow(SpecificAlternative flow) {
		super(new PropertyTableViewRow<SpecificAlternative>("", flow, SpecificAlternative.KEY_RFSSENTENCE) {
			...
			@Override
			protected String sycnPropertyToText(SpecificAlternative model) {
