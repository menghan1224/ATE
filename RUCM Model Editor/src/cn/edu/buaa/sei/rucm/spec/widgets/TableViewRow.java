...
/**
 * <code>TableViewRow</code> is the basic interface to present a single row for a {@link TableView}.
 * Clients can implement this interface from scratch to provide fully customized row, or reuse an existing row such
 * as {@link TextTableViewRow} or {@link PropertyTableViewRow}.
 * <p>
 * A <code>TableViewRow</code> contains two columns: key column and value column. To implement a single-column row, use
 * {@link SingleColumnRow}.
 * 
 * @author Gong Zhang
 *
 */
public interface TableViewRow {
