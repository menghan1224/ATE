package cn.edu.buaa.sei.rucm.wizards;
...
//	private NewModelWizardPage1 page1;
	private NewModelWizardPage1 page2;
...
//		addPage(page1);
		page2 = new NewModelWizardPage1(selection);
		addPage(page2);
	}
...
//		final String typeName = page1.getRootModelElementName();
	...
	private void saveInitialContent(IFile file) {
		// create root object
		ManagedObject object = LMFContext.newInstance(UCModel.TYPE_NAME);
	...
	private void throwCoreException(String message) throws CoreException {
		IStatus status =
			new Status(IStatus.ERROR, RUCMPlugin.PLUGIN_ID, IStatus.OK, message, null);
