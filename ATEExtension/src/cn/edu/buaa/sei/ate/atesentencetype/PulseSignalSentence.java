...
public class PulseSignalSentence implements TableAteViewRow{
	...
	List<TextCell> cellList=new ArrayList<TextCell>();
	{
		label1=new RowLabel(){
			...
			setIconSpacing(3);
			setIcon(RUCMPluginResource.getImage("pulse.png"));
...
//				getTextView().setDefaultTextColor(TextTableViewRow.LABEL_TEXT_COLOR);
	...
	public PulseSignalSentence(final TableAteView table,AteSentence sentence) {
