...
public class MonitorSentence implements TableAteViewRow{
...
//				getTextView().setDefaultTextColor(TextTableViewRow.LABEL_TEXT_COLOR);
	...
	public MonitorSentence(final TableAteView table,AteSentence sentence) {
