...
public class ValidateSentence implements TableAteViewRow{
	private TextCell mainCell;
	private TextCell conditionCell;
	private AteSentence sentence;
	
	private TextCellDelegate defaultDelegate;
	List<View> list=new ArrayList<View>();
	private DataBinding mainBinding;
...
//			getTextView().setDefaultTextColor(TextTableViewRow.LABEL_TEXT_COLOR);
	...
	public ValidateSentence(final TableAteView table,AteSentence sentence) {
...
//						cell.setCaretPosition(CaretIndex.before(cell.textLength() - text.length()));
			...
			mainCell=new TextCell(defaultDelegate, false, false);
			mainCell.setText("");
			mainCell.setHintText("MANUAL OR¡¡SYSTEMATIC");
			mainCell.setBreakIterator(null);
	...
	public void tableViewRowAdded(TableAteView table) {
		// TODO Auto-generated method stub
		mainBinding=new DataBinding(mainCell,TextCell.TEXT_CHANGED,sentence,AteSentence.KEY_NAME) {
			
			@Override
			protected void viewPropertyChanged(Object arg) {
				// TODO Auto-generated method stub
				sentence.setPara1(mainCell.getPlainText());
			}
			
			@Override
			protected void modelPropertyChanged(ManagedObject value) {
				// TODO Auto-generated method stub
				mainCell.setText(sentence.getPara1());
			}
		};
