...
public class LoopTImeLoopSentence implements TableAteViewRow{
	private TextCell timesCell;
	private TextCell statementCell;
	private AteSentence sentence;
	
	private TextCellDelegate defaultDelegate;
	List<View> list=new ArrayList<View>();
	private DataBinding timesBinding;
...
//			getTextView().setDefaultTextColor(TextTableViewRow.LABEL_TEXT_COLOR);
	...
	public LoopTImeLoopSentence(final TableAteView table,AteSentence sentence) {
...
//						cell.setCaretPosition(CaretIndex.before(cell.textLength() - text.length()));
			...
			timesCell=new TextCell(defaultDelegate, false, false);
			timesCell.setText("");
			timesCell.setHintText("TIMES");
			timesCell.setBreakIterator(null);
			statementCell=new TextCell(defaultDelegate, false, false);
			statementCell.setText("");
			statementCell.setHintText("CONDITION");
	...
	public void tableViewRowAdded(TableAteView table) {
		// TODO Auto-generated method stub
		timesBinding=new DataBinding(timesCell,TextCell.TEXT_CHANGED,sentence,AteSentence.KEY_NAME) {
			
			@Override
			protected void viewPropertyChanged(Object arg) {
				// TODO Auto-generated method stub
				sentence.setPara1(timesCell.getPlainText());
			}
			
			@Override
			protected void modelPropertyChanged(ManagedObject value) {
				// TODO Auto-generated method stub
				timesCell.setText(sentence.getPara1());
			}
		};
