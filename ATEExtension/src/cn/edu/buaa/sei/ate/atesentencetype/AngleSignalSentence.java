...
public class AngleSignalSentence implements TableAteViewRow{
	...
	private List<TextCell> cellList=new ArrayList<TextCell>();
	{
		label1=new RowLabel(){
			{
			...
			setIconSpacing(3);
			setIcon(RUCMPluginResource.getImage("angle.png"));
...
//				getTextView().setDefaultTextColor(TextTableViewRow.LABEL_TEXT_COLOR);
	...
	public AngleSignalSentence(final TableAteView table,AteSentence sentence) {
