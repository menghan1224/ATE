 ...
 * <ul>
 *   <li>{@link cn.edu.buaa.sei.lmf.meta.impl.EnumValueImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumValueImpl extends EObjectImpl implements EnumValue {
	...
	protected EClass eStaticClass() {
		return LMFPackage.Literals.ENUM_VALUE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LMFPackage.ENUM_VALUE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LMFPackage.ENUM_VALUE__NAME:
				return getName();
		}
